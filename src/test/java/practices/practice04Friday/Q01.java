...
//        Assert that total price is $140.34
        String totalPrice = driver.findElement(By.xpath("//div[@class='summary_total_label']")).getText();//tag name "div", attribute name"class"
...
//        Assert that CHECKOUT: COMPLETE!
        ...
        System.out.println("CHECKOUT: COMPLETE! ==>"+ checkOutText);
    }
}